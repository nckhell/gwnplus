          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 lg:mx-0 lg:max-w-none lg:grid-cols-2">
              ...
              <div className="mt-10 flex flex-auto flex-col justify-between">
                ...
                <div className="mt-4 flex items-center gap-x-6">
                  <div className="text-base">
                    <div className="font-semibold text-gwen-dark">— Britt</div>
                  </div>
                </div>
              </div>
            </div>
            <div className="flex flex-col border-t border-gray-900/10 pt-10 sm:pt-16 lg:border-l lg:border-t-0 lg:pl-8 lg:pt-0 xl:pl-20">
              <div className="mt-10 flex flex-auto flex-col justify-between">
                ...
                <div className="mt-4 flex items-center gap-x-6">
                  <div className="text-base">
                    <div className="font-semibold text-gwen-dark">— Inge</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="my-24">
        <div className="container-gwen text-center">
          <h2 className="text-3xl font-semibold text-slate-900 sm:text-4xl lg:text-4xl lg:leading-snug">
            Hoe kan ik jou <span className="text-gwen-dark">helpen?</span>
          </h2>
